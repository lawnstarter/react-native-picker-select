...
-   Now using [@react-native-picker/picker](https://github.com/react-native-picker/picker) under the hood (#340). For that reason, this library now requires React Native 0.60 or above. If using Expo, SDK38 or above is required.
