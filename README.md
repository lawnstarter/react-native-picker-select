...
| `items`                                         | The items for the component to render<br> - Each item should be in the following format:<br>`{label: 'Orange', value: 'orange', key: 'orange', color: 'orange', displayValue: true}`<br>- The label and the value are required<br>- Key, color and displayValue are optional<br>- The key will be set to the label if not included<br>- The value can be any data type<br>- if displayValue is present and set to true, the TextInput will show the value instead of the label                          | **required**<br>array    |
