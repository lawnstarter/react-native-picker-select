...
| `accessible`<br>                                | Controls whether the rendered picker should be accessible to screen readers. Defaults to `true`                                                                                                                                                                                                                                                                                                                                                                                                         | boolean                  |
| `accessibilityLabel`<br>                        | Allows for a custom label to be spoken by screen readers                                                                                                                                                                                                                                                                                                                                                                                                                                                | string                   |
