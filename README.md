...
| `formatValue(selectedItem)`<br>                                    | A function to return the formatted picker value label as a string. _                                                                                                                                                                                                                                                                                                                                                                                  | function                 |
