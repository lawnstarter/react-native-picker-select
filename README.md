...
| `Icon`                                          | Custom icon component to be rendered inside of the input. This is iOS only unless `useNativeAndroidPickerStyle={false}`.<br>_More details in [styling](#styling)_                                                                                                                                                                        | Component                |
