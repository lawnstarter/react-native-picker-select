...
| `titleText`<br>_iOS only_                       | Custom "Title" text on the modal.                                                                                                                                                                                                                                                                                                        | string                   |
...
| `showCancel`<br>_iOS only_                      | Replaces tabbing arrows with a 'Cancel' button that closes modal and cancels selection                                                                                                                                                                                                                                                   | boolean                  |
| `cancelText`<br>_iOS only_                      | 'Cancel' default text on the modal. Can be overwritten here                                                                                                                                                                                                                                                                              | string                   |
...
-   Other styles that can be modified for iOS are named `inputIOSContainer`, `placeholder`, `viewContainer`, `chevronContainer`, `chevron`, `chevronUp`, `chevronDown`, `chevronActive`, `done`, `title`, `cancel`, `modalViewTop`, `modalViewMiddle`, and `modalViewBottom`
