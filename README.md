...
| `placeholder`                                   | - An override for the default placeholder object with a label of `Select an item...` and a value of `null`<br>- An empty object can be used if you'd like to disable the placeholder entirely<br>-placeholder props: `{label: string,
      value: any,
      key: string | number,
      color: ColorPropType,
      size: number`                                                                                                                                           | object                   |
...
| `placeholderTextColor`                          | Overrides the default placeholder color shown.                                                                                                                                                                                                                                                                                           | color                    |
...
-   Other styles that can be modified for iOS are named `inputIOSContainer`, `viewContainer`, `chevronContainer`, `chevron`, `chevronUp`, `chevronDown`, `chevronActive`, `done`, `modalViewTop`, `modalViewMiddle`, and `modalViewBottom`
